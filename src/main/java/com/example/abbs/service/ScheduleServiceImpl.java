...
public class ScheduleServiceImpl implements ScheduleService{
	...
	public void updateSchedule(Schedule schedule) {
		scheDao.updateSchedule(schedule);
	}

	@Override
	public void deleteSchedule(int sid) {
		scheDao.deleteSchedule(sid);
	}
	...
	public SchDay generateSchDay(String uid, int day, String sdate, int date, int isOtherMonth) {
		...
		List<Schedule> scheList = scheDao.getSchedList(uid, sdate, sdate);
		...
		SchDay schDay = new SchDay(day, date, isHoliday, isOtherMonth, sdate, aList, scheList);
